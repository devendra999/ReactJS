...
const columns = ["File", "Sheet", "Uploaded On"];
      ...
      <SidebarWithLayout>
        ...
        <Box className="content-wrapper pb-6 pl-6 pr-6 h-full relative file-upload-page">
          {loadingBucketFileData ? (
            ...
            <Box className="main-header sticky top-0 bg-lightgrey z-[4] pt-4 pb-4 file-upload">
              <PanelHeading
                firstHeading={`Upload Files - ${currentBucket?.name}`}
              />

              <Box className="flex flex-start file-btn">
                <Box>
