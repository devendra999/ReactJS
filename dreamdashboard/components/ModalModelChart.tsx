...
interface ModalModelChartProps {
  openModal: boolean;
  closeModal: () => void;
...
const ModalModelChart: React.FC<ModalModelChartProps> = (props: any) => {
  ...
  const modelChartData = (kpiChartData as any)?.data[0]?.return_model;
            ...
            {chart3 && modelChartData ? (
              ...
              <Box className="card">
                {chart3 && modelChartData === null ? (
                  ...
                  <Loading
                    className={`${
                      chart3 && modelChartData ? "hide" : "insideChart"
                    } `}
                  />
                )}
              </Box>
...
export default ModalModelChart;
